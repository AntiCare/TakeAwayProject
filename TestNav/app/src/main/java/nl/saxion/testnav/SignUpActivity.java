...
public class SignUpActivity extends AppCompatActivity {
    ...
    MaterialEditText firstNam, lastNam, phoneNum, email, password;
    Button signUpBtn;
    FirebaseAuth auth;
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(input_firstNam)||TextUtils.isEmpty(input_lastNam)||TextUtils.isEmpty(input_phoneNum)||
                    ...
                    Toast.makeText(SignUpActivity.this,"please agree to the Terms& Condition",Toast.LENGTH_SHORT).show();
                        ...
                        register(input_firstNam,input_lastNam,input_phoneNum,input_email,input_password);
    ...
    private void register(final String firstName, final String lastName, final String phoneNum, final String email, final String password) {
